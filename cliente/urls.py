...
from .views import cliente_list, cliente_new, cliente_edit, ascensor_list, ascensor_new, ascensor_edit
...
urlpatterns = [
	...
	url(r'^editar-ascensor/(?P<pk>\d+)/$', login_required(ascensor_edit.as_view()), name='ascensor_editar'),
]